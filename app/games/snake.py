...
class SNAKE:
	...
	@direction.deleter
	def direction(self) -> None: del self._direction
	...
	# -- Pos --
	@property
	def pos(self) -> pygame.math.Vector2: return self._pos
...
def get_collision_points(snake : SNAKE) -> tuple[list[float], list[float]]:
		...
		p1 = [float(center_head_x), float(center_head_y)]
		p2 = [float(center_head_x), float(center_head_y)]
