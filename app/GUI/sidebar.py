...
class Sidebar:
	def __init__(self, width, height, screen_cover_ratio = .2, alpha = 1, bg_color = BG_COLOR):
	...
	def add_sidebar_content(self):
		snake = Button((30 , 30), 50, 20, "orange", on_click = create_snake, offset = self.rect.topleft)
		tictactoe = Button((30, 100), 50, 20, "red", on_click = create_tictactoe, offset = self.rect.topleft)
		wordle = Button((30, 170), 50, 20, "Yellow", on_click = create_wordle, offset = self.rect.topleft)
